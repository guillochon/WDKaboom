...
#include "Flash.h"
  ...
  integer, parameter ::  nGlobalSum = 9          ! Number of globally-summed quantities
...
!!$                   &    solnData(DENS_VAR,i,j,k) + solnData(MAGP_VAR,i,j,k))*dvol
              ...
              lsum(8) = lsum(8) + solnData(DENS_VAR,i,j,k)*solnData(ENUC_VAR,i,j,k)*dvol
#endif

#ifdef ECOO_VAR
              ! neutrino cooling rate
              lsum(9) = lsum(9) + solnData(DENS_VAR,i,j,k)*solnData(ECOO_VAR,i,j,k)*dvol
#endif
